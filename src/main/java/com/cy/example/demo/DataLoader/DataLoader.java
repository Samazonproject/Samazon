...
//        }
        ...
        Product product1 = new Product("Nike Shoe", "athletic shoes", new BigDecimal("100"), "Nike", "blue", "max cushion");
        ...
        Product product4= new Product("Travis ", "athletic shoes", new BigDecimal("100"), "Nike", "blue", "max cushion");
        productRepository.save(product4);

        Product product5 = new Product("Chanel Shoe", "athletic shoes", new BigDecimal("100"), "Nike", "blue", "max cushion");
        productRepository.save(product5);

        Product product6 = new Product("Burberry Shoe", "athletic shoes", new BigDecimal("100"), "Nike", "blue", "max cushion");
        productRepository.save(product6);

        Product product7 = new Product("Gucci", "athletic shoes", new BigDecimal("100"), "Nike", "blue", "max cushion");
        ...
        Product product11 = new Product("Rolex 2", "watch", new BigDecimal("10000000000"), "Gold", "Gold", "Presdiential");
        productRepository.save(product11);

        Product product12 = new Product("Diamomd bracelet", "KY jEWELERS", new BigDecimal("100"), "KAY", "blue", "EXPENSIVE");
        productRepository.save(product12);

        Product product13 = new Product("tELSA MODEL X", "CAR", new BigDecimal("100000000000"), "Telsa", "blue", "Fast");
        productRepository.save(product13);

        Product product14 = new Product("Lambo", "Car", new BigDecimal("300000000"), "lambo", "green", "super fast");
